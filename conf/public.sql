...
CREATE SEQUENCE "public"."user_permission_seq"
 ...
 START 1048
 CACHE 1;
SELECT setval('"public"."user_permission_seq"', 1048, true);
...
INSERT INTO "public"."user_permission" VALUES ('111', '131', '0', '13', 'icon-hand-right', '菜单权限', 'userPermission_html', '1');
INSERT INTO "public"."user_permission" VALUES ('131', null, '0', '12', 'icon-desktop', '系统设置', '', '1');
INSERT INTO "public"."user_permission" VALUES ('1029', null, '1', '11', 'icon-hand-right', '角色管理', 'securityRole_html', '1');
