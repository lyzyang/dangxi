...
!function ($) {
    ...
    //@update refresh停留在当前页面，reload返回第一页
    BootstrapTable.prototype.reload = function (params) {
    	this.options.pageNumber = 1;
    	this.refresh(params);
    }
    
    BootstrapTable.prototype.getParams = function () {
    	var par = {
    		"limit" : 10,
          "offset" : 1
    	};
    	if(this.options.pagination) {
    	 	par = {
    	 		"limit" : this.options.pageSize === this.options.formatAllRows() ?
                    this.options.totalRows : this.options.pageSize,
              "offset" : this.options.pageSize === this.options.formatAllRows() ?
                    '0' : this.options.pageSize * (this.options.pageNumber - 1)
    	 	}
        }
       return par;
