...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'files'. '/' . date("Y") . '/' . date("m"),
		'directory' => $baseDir . 'files'. '/' . date("Y") . '/' . date("m"),
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'images'. '/' . date("Y") . '/' . date("m"),
		'directory' => $baseDir . 'images'. '/' . date("Y") . '/' . date("m"),
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . 'flash'. '/' . date("Y") . '/' . date("m"),
		'directory' => $baseDir . 'flash'. '/' . date("Y") . '/' . date("m"),
		'maxSize' => 0,
